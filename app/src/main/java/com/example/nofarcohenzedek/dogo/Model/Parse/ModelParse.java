...
public class ModelParse {
    ...
    public interface GetUserListener {
        public void onResult(long id, String userName, String password, String firstName, String lastName, String phoneNumber, String address, String city);
    }
    ...
    public void getDogWalkerById(final long userId, final Model.GetDogWalkerListener listener) {
        UserParse.getUserById(userId, new GetUserListener() {
            @Override
            public void onResult(long id, final String userName, final String password, final String firstName, final String lastName, final String phoneNumber, final String address, final String city) {
                DogWalkerParse.getDogWalkerDetailsById(userId, new GetDogWalkerDetailsListener() {
                    @Override
                    public void onResult(long userId, long age, int priceForHour, boolean isComfortableOnMorning, boolean isComfortableOnAfternoon, boolean isComfortableOnEvening) {
                        final DogWalker dogWalker = new DogWalker(userId, userName, password, firstName, lastName, phoneNumber, address, city, age, priceForHour, isComfortableOnMorning, isComfortableOnAfternoon, isComfortableOnEvening);
    ...
    public void addDogWalker(long id, String userName, String password, String firstName, String lastName, String phoneNumber,
        ...
        UserParse.addToUsersTable(id, userName, password, firstName, lastName, phoneNumber, address, city);
    ...
    public void getAllDogWalkers(final Model.GetDogWalkersListener listener)
    {
        ...
        list.add(new DogWalker(2, "nofi","123456","nofar", "cz","033","סביון", "מודיעין", 22,20,true,true,true));
        list.add(new DogWalker(2, "tahat","1234","carmel", "bt","052456374","חרצית", "מודיעין", 25,40,true,false,true));
            ...
            public void onResult(long id, final String userName, final String password, final String firstName, final String lastName, final String phoneNumber, final String address, final String city) {
                getAllDogsOfOwner(userId, new Model.GetDogsListener() {
                    ...
                    public void onResult(List<Dog> dogs) {
                        DogOwner dogOwner = new DogOwner(userId, userName, password, firstName, lastName, phoneNumber, address, city, dogs);
